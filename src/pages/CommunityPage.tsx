...
export function CommunityPage() {
  ...
  const fetchMembers = useCallback(async (search?: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE}/communities/${encodeURIComponent(did)}/members?${params.toString()}`,
        { credentials: 'include' }
      );
      if (response.ok) {
  ...
  const handleJoinCommunity = useCallback(async () => {
    ...
    setJoinStatus(null);
    try {
      const response = await fetch(`${API_BASE}/communities/${encodeURIComponent(did)}/join`, {
        method: 'POST',
        credentials: 'include',
        headers: { ...csrfHeaders() },
      });
  ...
  const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE}/communities/${encodeURIComponent(did!)}/avatar`, {
        method: 'POST',
        credentials: 'include',
        headers: { ...csrfHeaders() },
        body: formData,
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE}/communities/${encodeURIComponent(did!)}/profile`, {
        method: 'PUT',
        credentials: 'include',
        headers: {
